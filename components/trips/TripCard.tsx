                ...
                <div className="flex items-start justify-between mb-3">
                    ...
                    {isOwner && (
                        <motion.button
                            ...
                            className="ml-2 p-1.5 text-charcoal-300 hover:text-terra-400 hover:bg-terra-100 rounded-lg transition-all duration-200 opacity-100 md:opacity-0 group-hover:opacity-100"
